...
<style lang="scss">
	...
	.acea-row.row-between-wrapper{align-items:center;justify-content:space-between;}
	 .specialArea{padding:30rpx;}
	 .specialArea .assemble{width:260rpx;height:260rpx;position:relative;box-shadow: 0 2px 10px 2px #f1f1f1;border-radius: 6px;}
	 .specialArea .assemble image{width:100%;height:100%;border-radius: 6px;}
	 .specialArea .assemble .text{position:absolute;top:37rpx;left:20rpx;}
	 .specialArea .name{font-size:30rpx;color:#000;}
	 .specialArea .infor{font-size:22rpx;color:rgba(194, 192, 192, 0.8);margin-top:10rpx;}
	.specialArea .list{height:260rpx;width:416rpx;}
	.specialArea .item{width:100%;height:124rpx;position:relative;box-shadow: 0 2px 10px 2px #f1f1f1;border-radius: 6px;}
	 .specialArea .item image{width:100%;height:100%;border-radius: 6px;}
	 .specialArea .item .text{position:absolute;top:15rpx;left:28rpx;}
	...
	.page-index {
		...
		.page_content {
			...
			.barg {
				...
				margin-top: 20rpx;
				padding-left: 20rpx;
				background-image: url('https://api.duodianshop.com/barg002.png');
				background-size: 100% 100%;
